...
import co.rytikov.xyzreader.ui.DrawInsetsFrameLayout;
import co.rytikov.xyzreader.ui.ObservableScrollView;


/**
 * A fragment representing a single Article detail screen. This fragment is
 * either contained in a {@link MainArticleListActivity} in two-pane mode (on
...
public class ArticleDetailFragment extends Fragment implements
    ...
    @Bind(R.id.meta_bar) LinearLayout metaBar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBarFullOpacityBottom = getResources()
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bylineView.setText(Html.fromHtml(getString(R.string.article_subtext, date, author)));
