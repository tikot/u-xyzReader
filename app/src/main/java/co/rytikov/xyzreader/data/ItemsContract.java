package co.rytikov.xyzreader.data;

import android.net.Uri;

public class ItemsContract {
	public static final String CONTENT_AUTHORITY = "co.rytikov.xyzreader";
	public static final Uri BASE_URI = Uri.parse("content://co.rytikov.xyzreader");
	...
	public static class Items implements ItemsColumns {
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.co.rytikov.xyzreader.items";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.co.rytikov.xyzreader.items";
